 ...
 <br>
  ...
  <hr><hr>
    ...
    <?php
      ...
      <div class="col">
      <p><button class="btn btn-primary float-end addFriend" href="#" id="<?php echo ($val['user_id'])   ?>" onclick="this.innerHTML='Request SENT';this.css('color','black')">Add Friend</button></p>
      ...
      <?php
            ...
            <div class="col">
            <p><a class="btn btn-primary float-end addFriend" href="#" id="<?php echo ($_SESSION['findFriendId']);   ?>">Add Friend</a></p>
